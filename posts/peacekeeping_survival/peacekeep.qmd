...
This topic has been on my mind for a while. I theorize (based on nothing but my gut) that there might be a relationship between duration of a peacekeeping mission and the type of war that just occurred. 
...
I will fit several parametric survival models using different distributions. Last, I'll look at the (non-parametric) Cox proportional hazards model, which offers an alternative perspective on analyzing covariate effects. 
